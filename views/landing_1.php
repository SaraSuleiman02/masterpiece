    ...
    <div class="container py-5 my-5 text-center">
        <div class="row g-4 pt-4 justify-content-around">
            ...
            <div class="col-12 col-md-auto">
                <div class="priv-card card border-0 text-center d-flex align-items-center justify-content-center p-3 slide-from-left">
                    <div>
                    ...
                    <h4 class="card-title py-2 m-0">Qualified Team</h4>
                    <div class="card-text">
                        <p class="blog-paragraph fs-6">Angels employs the best events experts in Jordan to help you make your events unforgettable.</p>
                    </div>
                </div>
            </div>
            ...
            <!-- Card 2 -->
            <div class="col-12 col-md-auto">
                <div class="priv-card card border-0 text-center d-flex align-items-center justify-content-center p-3 slide-from-top">
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="3em" height="3em" viewBox="0 0 32 32">
                            <path fill="currentColor" d="m25 10l1.593 3l3.407.414l-2.5 2.253L28 19l-3-1.875L22 19l.5-3.333l-2.5-2.253L23.5 13zm-3 20h-2v-5a5.006 5.006 0 0 0-5-5H9a5.006 5.006 0 0 0-5 5v5H2v-5a7.01 7.01 0 0 1 7-7h6a7.01 7.01 0 0 1 7 7zM12 4a5 5 0 1 1-5 5a5 5 0 0 1 5-5m0-2a7 7 0 1 0 7 7a7 7 0 0 0-7-7" />
                        </svg>
                    </div>
                    <h4 class="card-title py-2 m-0">Professional Approach</h4>
                    <div class="card-text">
                        <p class="blog-paragraph fs-6">We will thoroughly plan every element of your wedding ceremony so that you could enjoy your most important day.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-auto">
                <div class="priv-card card border-0 text-center d-flex align-items-center justify-content-center p-3 slide-from-right">
                    ...
                    <div class="card-text">
                        <p class="blog-paragraph fs-6">Our clients value our affordable pricing policy and great service that allow us to plan the best weddings.</p>
                    </div>
                </div>
            </div>
        </div>
