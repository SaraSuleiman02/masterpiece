            ...
            <div id="sidebar" class="sidebar sidebar-with-footer">
                ...
                <div class="app-brand">
                    <a href="{{ route('dashboard.home') }}">
                        <img src="{{ asset('assets/images/logo.png') }}" alt="Lumora">
                    </a>
                </div>
                ...
                <div class="sidebar-left" data-simplebar style="height: 100%;">
                    ...
                    <ul class="nav sidebar-inner" id="sidebar-menu">
                        ...
                        <li class="{{ request()->routeIs('dashboard.user_details') ? 'active' : '' }}">
                            <a class="sidenav-item-link" href="{{ route('dashboard.user_details') }}">
                        ...
                        <li class="{{ request()->routeIs('dashboard.vendor') ? 'active' : '' }}">
                            <a class="sidenav-item-link" href="{{ route('dashboard.vendor') }}">
                        ...
                        <li class="{{ request()->routeIs('dashboard.appointment') ? 'active' : '' }}">
                            <a class="sidenav-item-link" href="{{ route('dashboard.appointment') }}">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user-menu">
                                <button class="dropdown-toggle nav-link" data-toggle="dropdown">
                                    <img src="{{ asset('assets/images/user/user.jpg') }}"
                                        class="user-image rounded-circle" alt="User Image" />
                                    {{-- Change it to be dynamic --}}
                                </button>
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li>
                                        <a class="dropdown-link-item" href="{{ route('dashboard.profile') }}">
